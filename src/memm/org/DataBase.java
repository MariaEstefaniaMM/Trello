...
import memm.org.utilities.Conn;
...
public class DataBase {
	...
	public int checkSignup(String email, String username) {
		int id =0;
		System.out.println(prop.getValue("query_checksignup"));
		try {
			...
			if(this.rs.next()) {
				...
				username=this.rs.getString("user_username");
	...
	public int getUserId(String email, String password) {
			int id = 0;
			System.out.println(prop.getValue("query_checkuser"));
			try {
				this.pstmt = this.con.prepareStatement(prop.getValue("query_checkuser"));
			    this.pstmt.setString(1, email);
	...
	//------ ADD ACCOUNT IN DB-------
		...
		public void newAccount(String name, String lastname, String username, String password,String email ) {
			System.out.println(prop.getValue("query_addUser"));
			try {
				...
				this.pstmt.setString(5,Encrypt.returnEncrypt(password));
